...
public partial class MasterBathroomViewModel : ObservableObject
{
    public MasterBathroomViewModel()
    {
        if (System.ComponentModel.DesignerProperties.GetIsInDesignMode(new DependencyObject()))
        {
            LightViewModel top = new(new Light(1, "Front", 1,  LightState.On, new( true, true), "FFFFFF",  100));
           
            LightViewModel vanity = new(new Light(19, "Back", 1, LightState.On, new(true, true), "FFFFFF", 100));
    ...
    public MasterBathroomViewModel(LightViewModel top, LightViewModel vanity)
    {
        TopLights = top;
        VanityLights = vanity;
